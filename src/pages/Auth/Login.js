            ...
            <div className="row gy-5 justify-content-center">
              ...
              <div className="col-12 col-lg-2 d-flex align-items-center justify-content-center gap-3 flex-lg-column">
                ...
                <div
                  ...
                  style={{ height: "1px", "--bs-bg-opacity": ".1" }}
                ></div>
                <div>or</div>
                <div
                  className="bg-dark h-100 d-none d-lg-block"
                ...
                <div className="d-flex gap-3 flex-column w-100">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 16 16"
                    >
                      <path d="M16 8.049c0-4.417-3.583-8-8-8S0 3.632 0 8.049c0 4.001 3.095 7.293 7.088 7.92v-5.59H4.912V8.418h2.176V6.496c0-2.146 1.218-3.372 3.145-3.372.91 0 1.849.073 2.637.142v3.048h-1.5c-1.17 0-1.442.558-1.442 1.365v1.818h2.889l-.379 2.961H9.707v5.544C13.909 15.342 16 12.05 16 8.049z" />
                    </svg>
                    <span className="ms-2 fs-6 flex-grow-1">
